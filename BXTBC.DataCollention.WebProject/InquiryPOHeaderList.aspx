<%@ Page Async="true" Language="C#" MasterPageFile="~/Mobile.master" AutoEventWireup="true" CodeFile="InquiryPOHeaderList.aspx.cs" Inherits="InquiryPOHeaderList" %>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="table-responsive">
                    <asp:GridView ID="gvPOHeaderList" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="No" HeaderText="No" ReadOnly="True" SortExpression="No" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                            
                            <asp:BoundField DataField="BuyfromVendorNo" HeaderText="Buyfrom" ReadOnly="True" SortExpression="BuyfromVendorNo" ItemStyle-CssClass="visible-xs" HeaderStyle-CssClass="visible-xs" />
                            ...
                            <%--<asp:BoundField DataField="DocumentType" HeaderText="Type" ReadOnly="True" SortExpression="DocumentType" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />--%>
                        </Columns>
                        <PagerTemplate>
                            ...
                            <asp:Label ID="lbl_nowpage" runat="server" Text="<%#gvPOHeaderList.PageIndex+1 %>" ForeColor="#db530f"></asp:Label> page / total<asp:Label ID="lbl_totalpage" runat="server" Text="<%#gvPOHeaderList.PageCount %>" ForeColor="#db530f"></asp:Label>
                        </PagerTemplate>
                    </asp:GridView>
                </div>
            </div>
