<%@ Page Async="true" Language="C#" MasterPageFile="~/Mobile.master" AutoEventWireup="true" CodeFile="POPosting.aspx.cs" Inherits="POPosting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="mainContainer" class="container">
        ...
        PO:
        <asp:Label ID="curDocument" runat="server" Text="Label"></asp:Label>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvReceivedList" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Type" HeaderText="Type" ReadOnly="True" SortExpression="Type" ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs" Visible="false" />
                         <%--   <asp:BoundField DataField="DocumentNo" HeaderText="DocumentNo" ReadOnly="True" SortExpression="DocumentNo" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />--%>
                           ...
                           <%-- <asp:BoundField DataField="BuyfromVendorNo" HeaderText="BuyfromVendorNo" ReadOnly="True" SortExpression="BuyfromVendorNo" ItemStyle-CssClass="visible-xs" HeaderStyle-CssClass="visible-xs" />--%>
                            <asp:BoundField DataField="CurrRece" HeaderText="Received" ReadOnly="True" SortExpression="CurrRece" ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs" />
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="ComfirmPost" runat="server" Text="ComfirmPost"
                        Width="100px" OnClick="ComfirmPosting_Click" Font-Size="8pt" class="btn btn-primary" />
                </td>
               <%-- <td>
